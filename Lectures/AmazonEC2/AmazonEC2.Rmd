...
You have been sent a key file called physaliaXX.pem, where XX is a number unique to your account. You will need this number for all the commands below. The examples will be for the user physalia28 - you will need to replace 28 with your own, unique number.
