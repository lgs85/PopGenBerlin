...
setwd("~/Documents/Teaching/PopGenBerlinLGS/session4_output/")
...
<div class="fold s">
```{R}
pd <- read.table("~/Documents/Teaching/PopGenBerlinLGS/session4_output/pairwise_fst.txt",as.is = T) #Or wherever you have put this
head(pd)
```
</div>
...
<div class="fold s">
```{R}
ll <- read.table("~/Documents/Teaching/PopGenBerlinLGS/session4_output/LatLong.txt", header = T,as.is = T) #Or wherever you have put this
ll
```
</div>
...
<div class="fold s">
```{R}
pca1 <- read.table("~/Documents/Teaching/PopGenBerlinLGS/session4_output/GreatTitsFilteredPrunedUnrel.eigenvec") #Or wherever you have put this
head(pca1)
```
</div>
...
```{r}
source("~/Documents/Teaching/PopGenBerlinLGS/session4_output/Admixture_plot.R") #Or whatever the path to this script is
```
...
```{r,fig.height = 3}
K2 <- read.table("~/Documents/Teaching/PopGenBerlinLGS/session4_output/GreatTitsThinned.2.Q")
mypops <- read.table("~/Documents/Teaching/PopGenBerlinLGS/session4_output/GreatTitsThinned.fam")
...
K3 <- read.table("~/Documents/Teaching/PopGenBerlinLGS/session4_output/GreatTitsThinned.3.Q")
D <- admixtureplot(str_out = K3,k = 3, pops = mypops, xaxis = F)

K4 <- read.table("~/Documents/Teaching/PopGenBerlinLGS/session4_output/GreatTitsThinned.4.Q")
E <- admixtureplot(str_out = K4,k = 4, pops = mypops, xaxis = T)
```
</div>
