...
## The data
We will be using a large SNP dataset from nine European great tit populations to explore continental-scale genomic structure. The data are stored as plink files on the "population_structure" on the server. Log onto the server and copy the directory to your working folder. Then use the command line to explore the files to try to figure out how many individuals and SNP markers have been typed.
