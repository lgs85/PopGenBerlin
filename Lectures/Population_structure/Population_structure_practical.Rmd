...
setwd("~/Documents/Teaching/PopGenBerlinLGS/session_4_output/")
...
<div class="fold s">
```{R}
pd <- read_delim("~/Documents/Teaching/PopGenBerlinLGS/session_4_output/pairwise_fst.txt", delim = "\t",col_names = F) #Or wherever you have put this
pd
```
</div>
...
<div class="fold s">
```{R}
ll <- read_delim("~/Documents/Teaching/PopGenBerlinLGS/session_4_output/LatLong.txt", delim = "\t") #Or wherever you have put this
ll
```
</div>
...
<div class="fold s">
```{R}
pca1 <- read_delim("~/Documents/Teaching/PopGenBerlinLGS/session_4_output/GreatTitsFilteredPrunedUnrel.eigenvec", delim = " ",col_names = F) #Or wherever you have put this
head(pca1)
```
</div>
...
```{r}
source("~/Documents/Teaching/PopGenBerlinLGS/session_4_output/Admixture_plot.R") #Or whatever the path to this script is
```
...
```{r,fig.height = 3}
K2 <- read_delim("~/Documents/Teaching/PopGenBerlinLGS/session_4_output/GreatTitsThinned.2.Q", delim = " ",col_names = F)
mypops <- read_delim("~/Documents/Teaching/PopGenBerlinLGS/session_4_output/GreatTitsThinned.fam", delim = " ",col_names = F)
...
K3 <- read_delim("~/Documents/Teaching/PopGenBerlinLGS/session_4_output/GreatTitsThinned.3.Q", delim = " ", col_names = F)
D <- admixtureplot(str_out = K3,k = 3, pops = mypops, xaxis = F)

K4 <- read_delim("~/Documents/Teaching/PopGenBerlinLGS/session_4_output/GreatTitsThinned.4.Q", delim = " ", col_names = F)
E <- admixtureplot(str_out = K4,k = 4, pops = mypops, xaxis = T)
```
</div>
