...
## The data
Scientists have taken blood samples from a rare passerine bird species captured from mainland and island populations. They have genotyped all the samples at a single nucleotide polymorphism (SNP), at which they found two alleles (A and C). They wish to know whether, at this locus, the mainland and island populations have different levels of genetic diversity.
...
We can also use square bracket notation to call up individual rows and column. Using this notation, get R to print out (if you can't remember how to do this, use the internet):

- the 45th row
- the 2nd column
- the genotype for the 22nd individual
...
So coming back to our SNP data, we can use the `==` operator to ask whether an individual is a homozygote, by asking whether the variables `Allele_1` and `Allele_2` are the same.
