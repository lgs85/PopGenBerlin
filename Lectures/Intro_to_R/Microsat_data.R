...
genotypes <- c("100100","100102","102102")
...
p1 <- data.frame(Allele_1 = substr(p1_genos,1,3),Allele_2 = substr(p1_genos,4,6),Pop = rep("Mainland",popsize))
...
p2 <- data.frame(Allele_1 = substr(p2_genos,1,3),Allele_2 = substr(p2_genos,4,6),Pop = rep("Island",popsize))
