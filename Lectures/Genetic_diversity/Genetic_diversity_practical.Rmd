...
Because LD is calculated between *pairs* of markers, the number of calculations vcftools would have to perform for a whole genome dataset would be huge, and unnecessary for our purposes here. We will therefore restrict our analyses to i) the first million basepairs of a single chromosome (ChLG6), ii) pairs of markers within 100 kb of each other, and iii) pairs of markers with R2 values > 0.001. Using this information, can you calculate LD for both the MB and FA populations? Answer below.

<div class="fold s">
```{r eval = F}
vcftools --vcf TriboliumSSGenomes.vcf --geno-r2 --chr ChLG6 --ld-window-bp 100000 --from-bp 0 --to-bp 1000000 --min-r2 0.001 --indv 2014_SOL_MG4955 --indv 2014_SOL_MG4956 --indv 2014_SOL_MG4957 --out TriboliumSSGenomesMB

vcftools --vcf TriboliumSSGenomes.vcf --geno-r2 --chr ChLG6 --ld-window-bp 100000 --from-bp 0 --to-bp 1000000 --min-r2 0.001 --indv 2014_SOL_MG4972 --indv 2014_SOL_MG4973 --indv 2014_SOL_MG4974 --out TriboliumSSGenomesFA
