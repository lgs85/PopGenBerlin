...
het <- read_delim("~/Documents/Teaching/PopGenBerlinLGS/session_3_output/TriboliumSSGenomes.het",delim = "\t")
pi_MB <- read_delim("~/Documents/Teaching/PopGenBerlinLGS/session_3_output/TriboliumSSGenomesMB.windowed.pi",delim = "\t")
pi_FA <- read_delim("~/Documents/Teaching/PopGenBerlinLGS/session_3_output/TriboliumSSGenomesFA.windowed.pi",delim = "\t")
ld <- read_csv("~/Documents/Teaching/PopGenBerlinLGS/session_3_output/TriboliumSSGenomes.windowed.ld.csv") #Or whatever you have called it
