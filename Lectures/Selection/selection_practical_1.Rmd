...
- Only synonymous SNPs
- Only non-synonymous (missense) SNPs
- Only SNPs in the BRCA1 gene
...
java -jar SnpSift.jar filter "ANN[*].GENE = 'TC004535'" Tribolium.ann.vcf > Tribolium.ann.brca1.vcf
