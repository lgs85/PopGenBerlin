...
## The data
We will be using the *Tribolium castaneum* genomes from the genetic diversity practical. Change your working directory to the selection folder.
...
(HINT - use `selection\/*.pi` within `scp` to download all files ending in ".pi" from a particular folder.)
