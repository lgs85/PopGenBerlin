...
## The data
We will be using the Tribolium sexual selection data from the genomic diversity practical. Log into your working folder on the Amazon server, and within your Data folder, copy TriboliumSSGenomes.vcf from the genetic diversity folder into the selection folder. Now change your working directory to the selection folder.
